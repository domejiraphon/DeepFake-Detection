...
class FaceMask(Dataset):
    def __init__(self, rootpth, cropsize=(640, 480), mode='train', *args,
                 **kwargs):
    ...
    def __getitem__(self, idx):
        ...
        label = Image.open(
            osp.join(self.rootpth, 'mask', impth[:-3] + 'png')).convert('P')
...
if __name__ == "__main__":
    ...
    for i in range(15):
        ...
        atts = ['skin', 'l_brow', 'r_brow', 'l_eye', 'r_eye', 'eye_g', 'l_ear',
                'r_ear', 'ear_r',
                'nose', 'mouth', 'u_lip', 'l_lip', 'neck', 'neck_l', 'cloth',
                'hair', 'hat']
