...
def paste_over(im_src, occluder_mask, im_dst, dst_mask, center, occlusion_mask,
    ...
    occluder_mask = occluder_mask[start_src[1]:end_src[1],
    ...
    occlusion_mask[start_dst[1]:end_dst[1], start_dst[0]:end_dst[0]] = cv2.add(
        occlusion_mask[start_dst[1]:end_dst[1], start_dst[0]:end_dst[0]],
        occluder_mask)

    dst_mask[start_dst[1]:end_dst[1], start_dst[0]:end_dst[0]] = cv2.subtract(
        dst_mask[start_dst[1]:end_dst[1], start_dst[0]:end_dst[0]],
        occluder_mask)
