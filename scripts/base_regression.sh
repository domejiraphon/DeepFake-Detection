...
singularity exec --nv --overlay /scratch/jy3694/data/face_occlusion.sqf:ro\
    ...
    /bin/bash -c "source /ext3/env.sh;python main.py --use_self_blended --model_dir regression --use_retinafacenet --use_keypoint --use_regression --lpips --visualized --restart"